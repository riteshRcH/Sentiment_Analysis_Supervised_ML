<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="Mine.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<artisteer:Article ID="Article1" Caption="Welcome! :)" runat="server"><ContentTemplate>
    ...
    <%--<a href="javascript:void(0)" title="link">link</a>, <a class="visited" href="javascript:void(0)" title="visited link">
        visited link</a>,
     <a class="hover" href="javascript:void(0)" title="hovered link">hovered link</a> --%><p>
        </p>
        <p>
        </p>
    </p>
           </ContentTemplate></artisteer:Article>
           <asp:TextBox ID="TextBox1" runat="server" Width="1000" Height = "1000" 
