<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="KnowMore.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<artisteer:Article ID="Article1" Caption="Welcome" runat="server"><ContentTemplate>
    <img src="images/BlogMiner.png" alt="an image" style="float:left;" />
    ...
    <p>
    	<span class="art-button-wrapper">
    		...
    		<a class="art-button" href="About.aspx">Know technically more!...</a>
    	</span>
    </p>
    ...
    <div class="art-content-layout overview-table">
        ...
        <div class="overview-table-inner">
    		  <h4>Development Strategy: How it works! :)    </h4>
    						  ...
    						  <p><a href="Home.aspx" >Click here to know more!</a></p>
                  </div>
    		</div><!-- end cell -->
    	</div><!-- end row -->
    </div><!-- end table -->
