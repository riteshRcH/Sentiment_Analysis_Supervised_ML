<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="GetStarted.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<artisteer:Article ID="Article1" Caption=" Get Started :)" runat="server"><ContentTemplate>
    ...
    <p>
    	<span class="art-button-wrapper">
    		...
    		<a class="art-button" href="Mine.aspx">Mine!!</a>
    	</span>
    </p>
    </p __designer:mapid="5c">
