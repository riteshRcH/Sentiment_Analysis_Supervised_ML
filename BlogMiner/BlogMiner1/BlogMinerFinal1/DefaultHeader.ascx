...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="544" id="art-flash-object">
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="images/flash.swf" width="100%" height="544">
        <param name="quality" value="high" />
	    <param name="scale" value="exactfit" />
	    <param name="wmode" value="transparent" />
	    <param name="flashvars" value="color1=0xFFFFFF&amp;alpha1=.50&amp;framerate1=24&amp;loop=true&amp;wmode=transparent" />
...
<div class="art-logo">
        <h1 class="art-logo-name"><a href="Home.aspx">Blog Miner</a></h1>
            <h2 class="art-logo-text">Yes, We Digg it 4 u!</h2>
    </div>
