<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<artisteer:Article ID="Article1" Caption="Welcome! :)" runat="server"><ContentTemplate>
    ...
    <%--<a href="javascript:void(0)" title="link">link</a>, <a class="visited" href="javascript:void(0)" title="visited link">
     ...
     <br />
        With increasing usage of the world&#39;s biggest library: The INTERNET and social 
        networking, blogging and blog pages are growing rapidly. Blog pages have become 
        the most popular means to express one&#39;s opinions. People share their ideas, 
        opinions, interests, emotions, experiences and knowledge with other via internet 
        every day.<p>
        </p>
        <br />
        <p>
            Our application grabs the comments and movie reviews from well known sites and 
            parses it in a manageable, easy to use format. The parsed data is then analyzed 
            i.e it is termed as sentiment analysis; the sentiments expressed by the 
            commenters and reviewers is analyzed and studied carefully: correcting its 
            spelling, determining subjectivity and the sentiment orientation in terms of 
            positive and negative scores.</p>
        <br />
        <p>
            The scores are then summed up to get the final sentiment score for the whole 
            movie as well as for the individual categories such as director, actor/actress 
            etc</p>
        <p>
            <span class="art-button-wrapper"><span class="art-button-l"></span>
            <span class="art-button-r"></span><a class="art-button" href="KnowMore.aspx">
            Know technically more!...</a> </span>
        </p>
        <div class="cleared">
        </div>
            ...
            <div class="art-content-layout-row">
                <div class="art-layout-cell">
                    <div class="overview-table-inner">
                        <h4>
                            Support/Contact</h4>
                        <img alt="an image" class="image" height="55" src="images/01.png" width="55" />
                        <p>
                            <a href="Home.aspx">Click here to contact us!</a></p>
                    </div>
                </div>
                <!-- end cell -->
                <%--<div class="art-layout-cell">
    		  ...
    		  <h4>Development</h4>
                ...
                <div class="art-layout-cell">
                    <div class="overview-table-inner">
                        ...
                        <img alt="an image" class="image" height="55" src="images/03.png" width="55" />
                        <p>
                            <a href="KnowMore.aspx">Click here to know more!</a></p>
                    </div>
                </div>
                <!-- end cell -->
            </div>
